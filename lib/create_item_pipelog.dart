...
class create_pipelog extends StatefulWidget {
  const create_pipelog({Key key}) : super(key: key);

  @override
  State<create_pipelog> createState() => _create_pipelogState();
}

class _create_pipelogState extends State<create_pipelog> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Create Pipe Log Item'),
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          create_pipelog(); // call choose image function
                        },
